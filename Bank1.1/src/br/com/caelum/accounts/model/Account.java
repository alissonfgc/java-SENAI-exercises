...
//jar -cvf banco.jar br/com/caelum/util/*.class br/com/caelum/caelum/*.class;
...
public class Account {
	...
	public String dataPrint() {
		return String.format("ID: %d \n", Account.this.getIdACC())
				+ String.format("Holder: %s \n", Account.this.getHolderNameACC())
				+ String.format("Agency: %s \n", Account.this.getAgencyACC())
				+ String.format("Open date: %s \n", Account.this.getOpenDateACC())
				+ String.format("Balance: %.2f \n", Account.this.getBalanceACC())
